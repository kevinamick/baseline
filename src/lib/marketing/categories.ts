...
export const CATEGORIES = [
  {
    ...
    metaDescription:
      "LLM evaluation is how teams check whether their AI is good enough to ship — and keep it that way. Baseline turns evaluation into rubrics, scheduled runs, and automated optimization, no data-science team required.",
    ...
    intro:
      "LLM evaluation is how you find out whether your AI is good enough to put in front of customers — before they tell you it isn't. Baseline makes that measurable and repeatable: define what good looks like once, score every output against it, and let the system catch regressions and improve weak prompts on its own.",
    explainer: [
      "Large language models are non-deterministic: the same prompt can return a great answer today and a confusing one tomorrow. Without evaluation you're shipping on vibes — someone eyeballs a few outputs, declares it \"good enough,\" and quality drifts the moment a prompt, a model, or a vendor changes underneath you.",
      "LLM evaluation replaces the eyeball test with a measurement. You decide what a good output looks like, turn that into criteria, and score outputs against those criteria consistently — so \"is our AI working?\" stops being an opinion and becomes a number you can track over time and across releases.",
      "Done well, evaluation isn't a one-off audit. It runs continuously, flags regressions before customers hit them, and feeds directly into making the product better — which is exactly the loop Baseline is built around.",
    ],
    howBaseline: [
      {
        feature: "Rubrics",
        body: "Write down what a good output looks like as weighted criteria in plain language — no notebook, no eval framework to learn. Every Eval Run scores against that single shared definition.",
      },
      {
        feature: "Eval Runs",
      ...
      {
        feature: "Schedules",
        body: "Put evaluation on autopilot: re-run a Rubric against your live System on a cadence so a regression shows up on a dashboard, not in a support ticket.",
      },
      {
  ...
  },
  {
    ...
    metaDescription:
      "LLM-as-a-judge uses one AI model to grade another's outputs at scale. Baseline makes that judgment consistent and readable — graded against a rubric your whole team agrees on, not a black box.",
    ...
    intro:
      "LLM-as-a-judge is how you grade thousands of AI outputs without thousands of hours of human review: you ask a capable model to score the work against your criteria. The catch is trust — an ungrounded grader is just another opinion. Baseline anchors the judge to a Rubric your team wrote, so the scores are consistent, explainable, and reviewable.",
    explainer: [
    ...
    howBaseline: [
      ...
      },
      {
        ...
        body: "Spot-check the judge's calls and keep the rubric honest; the automated score handles the volume, your team keeps the final say.",
      },
    ],
    outcomes: [
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "It's a force multiplier. The judge handles volume; your team sets the criteria and keeps the final say on the calls that matter.",
      },
    ],
  },
  {
    ...
    explainer: [
      ...
      "Prompt optimization makes the improvement systematic. Instead of one person guessing, the system explores many candidate prompts, scores each against the same criteria, and keeps what actually performs — turning prompt engineering from an art into a measured search.",
      "The point isn't just a higher score; it's a defensible one. When a new prompt wins against the rubric your team agreed on, you can ship it knowing the gain is real and prove it to anyone who asks — not because it felt sharper.",
    ],
    howBaseline: [
      {
        feature: "Optimization Runs",
        body: "Point a run at the prompt you want to improve; it searches for stronger variations automatically instead of you editing and re-testing by hand.",
      },
      {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Anyone who can read results. The expert who owns the Rubric kicks off a run and reviews the proven lift — no prompt-engineering background required.",
      },
    ],
  },
  {
    ...
    explainer: [
      "Ask three people whether an AI answer is \"good\" and you'll get three answers — one cares about accuracy, one about tone, one about length. That disagreement is invisible until it ships as inconsistent quality, and it's why scores nobody defined are scores nobody trusts.",
      "A rubric makes the standard explicit. You break \"good\" into named criteria, weight them by what actually matters to your product, and now everyone — and every automated grader — scores against the same thing. The fuzzy judgment becomes a shared, written artifact your team owns.",
    ...
    howBaseline: [
      ...
      },
      {
        ...
        body: "Build and edit Rubrics in the browser in plain language — the domain expert who knows what good looks like owns the definition, no code required.",
      },
      {
        feature: "One shared definition",
        body: "The whole Team scores against the same Rubric; Readonly Members can view results without changing the criteria, so the standard stays stable.",
      },
      {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "The person who knows what good looks like — usually a domain expert or product owner, not an engineer. Baseline is built so they can author and edit it directly in the UI.",
      },
      {
