...
export const CATEGORIES = [
  {
    ...
    relatedSlugs: ["llm-as-judge", "rubric-based-evaluation", "prompt-optimization"],
  ...
  },
  {
    ...
    relatedSlugs: ["reduce-ai-hallucinations", "llm-evaluation", "llm-as-judge"],
  ...
  // don't cannibalize the generic evaluation page or each other.
  {
    ...
    relatedSlugs: ["ai-agent-testing", "rubric-based-evaluation", "prompt-optimization"],
    timeToComplete: "~20 min",
  ...
  },
  {
    ...
    relatedSlugs: ["prompt-optimization", "reduce-ai-hallucinations", "llm-evaluation"],
    timeToComplete: "~20 min",
