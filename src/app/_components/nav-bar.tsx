...
/**
 * App nav. A Client Component (#326 follow-up): it reads the Workspace name
 * from the client `AuthProvider` — seeded by the persistent
...
export function NavBar() {
  const { workspaceName } = useNavAuth();

  return <NavBarClient workspaceName={workspaceName} />;
}
