...
export function EmailTagsField({ id, tags }: { id: string; tags: EmailTags }) {
  return (
    <div
      className="flex min-h-[42px] flex-wrap gap-1.5 rounded-md border border-hairline-field bg-card p-2 transition focus-within:border-accent focus-within:ring-[3px] focus-within:ring-accent/50"
